            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="pedidos.php" method="POST">
                        Cod <input type="text" name="cod" id="cod" class="span3" value="" size=10 required placeholder="Cod" style=" margin-bottom: -2px; height: 25px;">
                        ...
                        Funcionario: <select name="codfunc" id="codfunc"   class="span3" style=" margin-bottom: -2px; height: 25px;">
                        ...
                        Cliente: <select name="codcli" id="codcli"   class="span3" style=" margin-bottom: -2px; height: 25px;">
                        ...
                        Produto: <select name="codprod" id="codprod"   class="span3" style=" margin-bottom: -2px; height: 25px;">
    ...
    <div class="container">
        <div class="row">
            ...
            <form action="pedidos.php" method="POST">
                <input type="text" name="cod" id="cod" placeholder="Cod pedido..." size=10 class="span4" style="margin-bottom: -2px; height: 25px;">
                <input type="date" name="datapedido" id="datapedido" placeholder="Data pedido..." class="span4" style="margin-bottom: -2px; height: 25px;">
